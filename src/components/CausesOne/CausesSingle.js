...
const CausesSingle = ({ cause = {}, causePage }) => {
  ...
  const { image, category, title, description, raised, goal ,amount} = cause;
      ...
      >
        <div className="causes-one__img">
          <div className="causes-one__img-box">
            <Image
              ...
              alt=""
            />
           <Link href={{ pathname: '/personal', query: { amount } }} legacyBehavior>
              <a>
                <i >
                ₹ {amount}
                </i> 
        ...
        <div className="causes-one__content">
          <h3 className="causes-one__title">
            <Link href={{ pathname: '/personal', query: { amount } }} legacyBehavior>{title}</Link>
          </h3>
