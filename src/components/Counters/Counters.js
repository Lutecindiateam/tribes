  ...
  return (
    <section className={`counters-one ${className}`}>
      ...
      <Container>
        ...
        <h2 style={{fontSize:"30px ", fontFamily:" sans-serif"}} className=" p-4 d-flex align-items-center justify-content-center"><b>Beneficial During Last Years</b></h2>
          {counter.map(({ id, count, letter, text }) => (
            <li className="counter-one__single p-5" key={id}>
